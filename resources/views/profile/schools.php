...
<div class='col-md-10'>
  ...
  <tr><th>ID</th><th>Picture</th><th>Name</th><th> Address</th><th>Description</th></th><th width="13%">Action</th></tr>
  <?php
  $root=Request::root();
  foreach($results as $key):
    ...
    $edit="<a href='$root/system-admin/school/edit/{$key->school_id}' class='btn btn-info'>Edit</a>";
    $delete="<a href='$root/system-admin/school/delete/{$key->school_id}' class='btn btn-danger'>Delete</a>";
  echo "<tr><td>{$key->school_id}</td><td>$pic</td><td><code>{$key->school_name}</code></td><td>{$key->school_address}</td><td>{$key->school_description}</td><td>$edit  $delete</td></tr>";
  endforeach;
  ?>
</table>
